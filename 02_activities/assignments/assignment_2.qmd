...
```{bash}
plink2 --bfile ./02_activities/data/gwa.qc.A2_pruned --keep ./02_activities/data/gwa.qc.A2_pruned.king.cutoff.in.id --make-bed --out ./02_activities/data/gwa.qc_unrelated.A2
```
